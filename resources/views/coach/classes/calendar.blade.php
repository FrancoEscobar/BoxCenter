...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventContent: function(arg) {
            ...
            let colorEstado = arg.event.backgroundColor;
            ...
            // VISTA MES
                ...
                let html = `
                    <div class="d-flex align-items-center w-100 px-1 overflow-hidden text-nowrap" 
                         style="border-left: 3px solid ${colorEstado}; padding-left: 4px;">
                        
                        <span class="fw-bold me-1 small">${timeStr}</span>
                        <span class="fw-semibold text-truncate me-auto small">${title}</span>
                        
                        <span class="badge ${badgeClass} ms-1" style="font-size: 0.7em;">
                            ${inscriptos}/${total}
                        </span>
                    </div>`;
                return { html: html };
